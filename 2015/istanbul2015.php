        ...
        <div id="page_wrapper">
            ...
            <div id="content">
            	<div class="content_wrapper">
                	<p class="content_smallTitle">21 February - Balkan Indoor Championships<br>Istanbul</p>
                    <hr width="40%" color="#0DB10F" size="1px"><br>
               		<div class="newsMain">
                    	<p><a href="pdf/Timetable BICH 2015.xlsx" style="color:black">Timetable</a></p>
                            <p><a href="pdf/BICH2015-Invitation.pdf" style="color:black" target="_blank">Invitation</a></p>
